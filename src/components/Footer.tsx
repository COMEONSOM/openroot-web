// ============================================================
// FOOTER — single file, fully merged
// No theme logic — owned globally by ThemeContext + App.tsx.
// No toggle button in footer — floating ThemeToggle in App.tsx.
// ============================================================
...
export default function Footer() {
  ...
  // Auto-open certificate modal when ?cert= param is present
  useEffect(() => {
          ...
          <div className="footer-card">
            ...
            <div className="footer-icon-row">
              <a
                ...
                className="footer-icon-btn" aria-label="WhatsApp"
              >
                <img src="/assets/whatsapp.svg" alt="WhatsApp" />
              </a>
              <a
                href="mailto:connect.openroot@gmail.com"
                className="footer-icon-btn" aria-label="Gmail"
              >
          ...
          <div className="footer-card">
            ...
            <div className="footer-icon-row">
              ...
              <a
                ...
                target="_blank" rel="noopener noreferrer"
                className="footer-icon-btn" aria-label="Facebook"
              >
