// ============================================================
// NAVBAR COMPONENT — CLEANED & OPTIMIZED
// VIEW MORE / OVERLAY SYSTEM REMOVED
// ============================================================
...
function isSafeInternalSlug(slug: string): boolean {
  ...
  if (!/^[a-z0-9-]{1,64}$/.test(slug)) return false;
...
SoftwareButton.displayName = "SoftwareButton";

// ─────────────────────────────────────────────────────────────
// SECTION 6: MAIN NAVBAR COMPONENT
// ─────────────────────────────────────────────────────────────
...
export default function Navbar() {
  ...
  const goTo = useCallback(
    (slug: string) => {
      if (!isSafeInternalSlug(slug)) {
        console.warn(
          "[Navbar] Blocked navigation to invalid slug."
        );
    ...
    <>
      <Helmet>
        <script type="application/ld+json">
          {safeJsonLd(siteNavSchema)}
        </script>

        <script type="application/ld+json">
          {safeJsonLd(siteNavigationSchema)}
        </script>
      </Helmet>

      <nav
        id="released-softwares-section"
        className={`navbar ${
          isCompactMode
            ? "navbar--compact"
            : ""
      ...
      >
        ...
        <div className="navbar-content">
          ...
          <div
            className={`released-softwares ${
              isCompactMode
                ? "released-softwares--compact"
                : ""
            }`}
            role="list"
          >
