...
export const softwareList = [
...

  {
    ...
    seoTitle: "Coevas Media Downloader – Download Videos & Audio Easily",
    seoDescription: "Download videos and audio from multiple platforms using Coevas Media Downloader, a lightweight desktop tool by Openroot.",
